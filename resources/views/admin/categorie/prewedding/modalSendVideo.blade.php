...
id="ModalSendVideoPrewedding{{ $user->id }}"
tabindex="-1"
...
<div
  ...
  <div
    ...
    <div
      ...
      <h5
        ...
        id="exampleModalLabel">
            Kirim Video Prewedding Kepada  <span class="italic">{{ $user->name }}</span>
      </h5>
      <!--Close button-->
      <button
        type="button"
    ...
    <!--Modal body-->
    <form action="{{ route('videoPreweddingUpload') }}" method="POST" enctype="multipart/form-data">
      @csrf
