...
@section('container')
    ...
    <section>
        <div class="flex justify-center items-center">
            <h1 class="lg:text-2xl font-semibold">Admin Prewedding</h1>
        </div>
        ...
        <div class="flex">
            ...
            <h1 class="font-semibold ml-2">Customer Prewedding</h1>
        </div>
     ...
     @endforeach
        ...
        <form action="{{ route('user.search.wedding', ['categoryName' => 'wedding']) }}" method="GET">
            <div
                ...
                <table class="min-w-full text-left text-sm font-light">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-neutral-500">
                            ...
                            @if ($user->imageWedding->isNotEmpty())
                                <img src="{{ asset('img/wedding/' . $user->imageWedding->first()->name) }}" alt="Customer Photo" class="h-10 w-10 rounded-full object-cover">
                            @else
                                <span>No Photo</span>
                            @endif
                            </td>
