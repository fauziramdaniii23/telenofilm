...
id="ModalSendPhotoEvent{{ $user->id }}"
tabindex="-1"
...
<div
  ...
  <div
    ...
    <div
      ...
      <h5
        ...
        id="exampleModalLabel">
            Kirim Photo Event Kepada  <span class="italic">{{ $user->name }}</span>
      </h5>
      <!--Close button-->
      <button
        type="button"
    ...
    <!--Modal body-->
    <form action="{{ route('imageEventUpload') }}" method="POST" enctype="multipart/form-data">
      @csrf
