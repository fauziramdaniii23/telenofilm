...
@section('container')
    ...
    <section>
        <div class="flex justify-center items-center">
            <h1 class="lg:text-2xl font-semibold">Admin Engagement</h1>
        </div>
        ...
        <div class="flex">
            ...
            <h1 class="font-semibold ml-2">Customer Engagement</h1>
        </div>
     ...
     @endforeach
        ...
        <form action="{{ route('searchUserEngagement', ['categoryName' => 'engagement']) }}" method="GET">
            <div
                ...
                <table class="min-w-full text-left text-sm font-light">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-neutral-500">
                            ...
                            @if ($user->imageEngagement->isNotEmpty())
                                <img src="{{ asset('img/Engagement/' . $user->imageEngagement->first()->name) }}" alt="Customer Photo" class="h-10 w-10 rounded-full object-cover">
                            @else
                                <span>No Photo</span>
                            @endif
                            </td>
                            ...
                            data-te-target="#ModalSendVideoEngagement{{ $user->id }}"
                            data-te-ripple-init
                            title="Send Video"
                            data-te-ripple-color="light">
                            ...
                            data-te-toggle="modal"
                            data-te-target="#ModalSendPhotoEngagement{{ $user->id }}"
                            data-te-ripple-init
                            title="Send Photo"
                            data-te-ripple-color="light">
                         ...
                         <form action="{{ route('deleteUserEngagement', ['userId' => $user->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
                          <button
                            type="submit"
                            ...
                            data-te-ripple-init
                            data-te-ripple-color="light"
                            onclick="return confirm('Hapus User dari kategori Engagement?')">
                        ...
                        @include('admin.categorie.engagement.modalSendPhoto')
                        @include('admin.categorie.engagement.modalSendVideo')
                        @endforeach
