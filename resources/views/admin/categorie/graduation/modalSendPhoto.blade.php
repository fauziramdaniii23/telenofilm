...
id="ModalSendPhotoGraduation{{ $user->id }}"
tabindex="-1"
...
<div
  ...
  <div
    ...
    <div
      ...
      <h5
        ...
        id="exampleModalLabel">
            Kirim Photo Graduation Kepada  <span class="italic">{{ $user->name }}</span>
      </h5>
      <!--Close button-->
      <button
        type="button"
    ...
    <!--Modal body-->
    <form action="{{ route('imageGraduationUpload') }}" method="POST" enctype="multipart/form-data">
      @csrf
