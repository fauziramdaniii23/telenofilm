...
@section('container')
    ...
    <section>
        <div class="flex justify-center items-center">
            <h1 class="lg:text-2xl font-semibold">Admin Graduation</h1>
        </div>
        ...
        <div class="flex">
            ...
            <h1 class="font-semibold ml-2">Customer Graduation</h1>
        </div>
     ...
     @endforeach
        ...
        <form action="{{ route('searchUserGraduation', ['categoryName' => 'graduation']) }}" method="GET">
            <div
                ...
                <table class="min-w-full text-left text-sm font-light">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-neutral-500">
                            ...
                            @if ($user->imageGraduation->isNotEmpty())
                                <img src="{{ asset('img/graduation/' . $user->imageGraduation->first()->name) }}" alt="Customer Photo" class="h-10 w-10 rounded-full object-cover">
                            @else
                                <span>No Photo</span>
                            @endif
                            </td>
                            ...
                            data-te-target="#ModalSendVideoGraduation{{ $user->id }}"
                            data-te-ripple-init
                            title="Send Video"
                            data-te-ripple-color="light">
                            ...
                            data-te-toggle="modal"
                            data-te-target="#ModalSendPhotoGraduation{{ $user->id }}"
                            data-te-ripple-init
                            title="Send Photo"
                            data-te-ripple-color="light">
                         ...
                         <form action="{{ route('deleteUserGraduation', ['userId' => $user->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
                          <button
                            type="submit"
                        ...
                        @include('admin.categorie.graduation.modalSendPhoto')
                        @include('admin.categorie.graduation.modalSendVideo')
                        @endforeach
