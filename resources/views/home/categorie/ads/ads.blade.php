<section class="bg-neutral-200">
    <div class="lg:flex justify-evenly">
        <div class=" lg:w-[40%] rounded-l-xl bg-cover " style="background-image: url('{{ asset('/ads.jpg') }}')">
            <div class="py-5 relative flex flex-col items-center justify-center bg-black/75 w-full h-full">
                 ...
                 <h1 data-aos="fade-up" class="tracking-widest text-xl lg:text-4xl text-white font-serif ">Ads</h1>
